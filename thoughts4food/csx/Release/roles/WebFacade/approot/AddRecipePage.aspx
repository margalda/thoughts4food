<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddRecipePage.aspx.cs" MasterPageFile="~/Site.Master" Inherits="WebFacade.AddRecipePage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style type="text/css">
        ...
        .auto-style1 { height: 35px; }

        .auto-style2 { height: 300px; }

        .auto-style3 { height: 200px; }

        .auto-style4 { width: 76.6em; }
    </style>
</asp:Content>
